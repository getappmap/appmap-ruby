  ...
  module Rails
    class SQLHandler
      ...
      def call(_, started, finished, _, payload) # (name, started, finished, unique_id, payload)
        return unless AppMap::Trace.tracer?
        ...
        AppMap::Trace.tracer.record_event(call)
        AppMap::Trace.tracer.record_event(SQLReturn.new(__FILE__, __LINE__, call.id, finished - started))
      end
